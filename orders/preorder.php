...
$form = "<h3 onclick=menuList('sidebar/menu.php');>Menu</h3><li><b style='font-size:18px;color:lightgray;' onclick=javascript:mapView()>Click to Toggle Map</b><br><br>";
...
$form .= '<div style=\'width:50%;display:table-cell;text-align:right;margin-right:20px\'><button style=\'background:black;color:green;border-radius:50%;font-size:18px;border:2px solid white;\' onclick="makePreorder();menuList(\'orders/preorder.php\')">&check;</button></div>';
$form .= '</div>';
